  ...
  return (
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8' >
        ...
        <nav>
          ...
          <CustomLink href="/education" title="Certificates" className='ml-4'/>
        </nav>
     
        <nav className='flex items-center justify-center flex-wrap'>
            <motion.a href="https://github.com/Shubham6909" target={'_blank'}
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className='w-6 mx-3'
            >
            ...
            <motion.a href="https://www.linkedin.com/in/gotoshubhamgupta/"
            whileHover={{y:-2}}
            whileTap={{scale:0.9}}
            className='w-6 mx-3'
            target={'_blank'}>
        ...
        {
          isOpen?(<motion.div initial={{scale:0,opacity:0,x:"-50%",y:"-50%"}} animate={{scale:1,opacity:1}} className='min-w-[70vw] z-30 flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'>
          <nav className='flex items-center flex-col justify-center'>
            <CustomMobileLink href="/" title="Home" className='' toggle={handleclick}/>
            <CustomMobileLink href="/about" title="About" className='' toggle={handleclick}/>
            <CustomMobileLink href="/projects" title="Projects" className='' toggle={handleclick}/>
            <CustomMobileLink href="/education" title="Certificates" className='' toggle={handleclick}/>
          </nav>
       
          <nav className='flex items-center justify-center flex-wrap mt-2'>
              <motion.a href="https://github.com/Shubham6909?tab=repositories" target={'_blank'}
              whileHover={{y:-2}}
              whileTap={{scale:0.9}}
