...
const Skill=({name,x,y})=>{
    return ( <motion.div
        ...
        py-3 px-6 shadow-dark cursor-pointer absolute dark:text-dark dark:bg-light lg:py-2 lg:px-4 md:text-sm md:py-1.5 md:px-3 xs:bg-transparent xs:dark:bg-transparent
...
const Skills = () => {
  return (
   ...
   '>
    ...
    <Skill name="Monogo DB" x="-25vw" y="18vw"/>
    <Skill name="Docker" x="-25vw" y="18vw"/>
    <Skill name="Tomcat Server" x="-25vw" y="18vw"/>
    <Skill name="Swagger" x="-25vw" y="18vw"/>
    <Skill name="DSA" x="-32vw" y="-3vw"/>
